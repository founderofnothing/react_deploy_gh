...
var bt = new Le(), St = new Le(), Tr = new Uint8Array(30), kr = new Uint16Array(30), Tt = new Uint8Array(30), kt = new Uint16Array(30), ga = new Uint8Array([16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15]), Br = new Le(), se = new Uint8Array(288 + 32);
function Ft(e, r, t, a) {
  var n, s;
  for (n = 0; n < t; ++n) e[n] = 0;
...
var U = { fail: Ut, argument: Pr, assert: Pr }, Gr = 32768, Nr = 2147483648, Fe = {}, g = {}, E = {};
function ae(e) {
  return function() {
    return e;
  };
...
var mr = "utf-16", Rn = { 0: "macintosh", 1: "x-mac-japanese", 2: "x-mac-chinesetrad", 3: "x-mac-korean", 6: "x-mac-greek", 7: "x-mac-cyrillic", 9: "x-mac-devanagai", 10: "x-mac-gurmukhi", 11: "x-mac-gujarati", 12: "x-mac-oriya", 13: "x-mac-bengali", 14: "x-mac-tamil", 15: "x-mac-telugu", 16: "x-mac-kannada", 17: "x-mac-malayalam", 18: "x-mac-sinhalese", 19: "x-mac-burmese", 20: "x-mac-khmer", 21: "x-mac-thai", 22: "x-mac-lao", 23: "x-mac-georgian", 24: "x-mac-armenian", 25: "x-mac-chinesesimp", 26: "x-mac-tibetan", 27: "x-mac-mongolian", 28: "x-mac-ethiopic", 29: "x-mac-ce", 30: "x-mac-vietnamese", 31: "x-mac-extarabic" }, wn = { 15: "x-mac-icelandic", 17: "x-mac-turkish", 18: "x-mac-croatian", 24: "x-mac-ce", 25: "x-mac-ce", 26: "x-mac-ce", 27: "x-mac-ce", 28: "x-mac-ce", 30: "x-mac-icelandic", 37: "x-mac-romanian", 38: "x-mac-ce", 39: "x-mac-ce", 40: "x-mac-ce", 143: "x-mac-inuit", 146: "x-mac-gaelic" };
function Yt(e, r, t) {
  switch (e) {
    case 0:
      return mr;
...
var Qt = { parse: Gn, make: Nn }, ee = new Array(9);
ee[1] = function() {
...
function ra(e) {
  ...
  for (var t = Kn(e), a = 0; a < t.length; ++a) {
    ...
    for (var l = 0; l < n.length; ++l) if (s = i, i = u, u = n[(l + 1) % n.length], i.onCurve) r.lineTo(i.x, i.y);
      ...
      var h = u;
      s.onCurve || { x: (i.x + s.x) * 0.5, y: (i.y + s.y) * 0.5 }, u.onCurve || (h = { x: (i.x + u.x) * 0.5, y: (i.y + u.y) * 0.5 }), r.quadraticCurveTo(i.x, i.y, h.x, h.y);
    }
    r.closePath();
  }
  return r;
...
var aa = { getPath: ra, parse: $n }, na, Se, sa, br;
function ia(e) {
...
var ua = function(e) {
...
}, oe = { x: 1, y: 0, axis: "x", distance: function(e, r, t, a) {
  ...
  e.xTouched = false;
} }, le = { x: 0, y: 1, axis: "y", distance: function(e, r, t, a) {
...
var De = Object.freeze(new fe(0, 0)), ss = { cvCutIn: 17 / 16, deltaBase: 9, deltaShift: 0.125, loop: 1, minDis: 1, autoFlip: true };
function de(e, r) {
...
var ho = { make: fo, parse: po }, co = function() {
...
var Mo = Object.freeze({ __proto__: null, Font: w, Glyph: Q, Path: P, BoundingBox: pe, _parse: k, parse: Dr, load: Bo, loadSync: Io }), Ho = Mo;
export {
  ne as Bidi,
  pe as BoundingBox,
  w as Font,
